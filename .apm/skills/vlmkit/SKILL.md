...
### The version these workflows are written against: 0.21.0
...
```sh
npx vlmkit --version     # vlmkit/0.21.0 darwin-arm64 node-v24.14.1
```

- **Older, or not installed** → install `@mizchi/vlmkit@0.21.0` and use that.
