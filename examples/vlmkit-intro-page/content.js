...
export const messages = Object.freeze({
  ja: Object.freeze({
    ...
    "skills.note": "1 インストール · 自動ルーティング · 17 ワークフロー",
    ...
    "skills.catalogLink": "17スキルの詳しい選択ガイドを見る",
    ...
    "skills.pluginLabel": "Claude Code プラグインとして導入",
    "skills.pluginDescription": "同じパッケージを Claude Code の中から、シェルなしで追加します。",
  ...
  en: Object.freeze({
    ...
    "skills.note": "1 install · automatic routing · 17 workflows",
    ...
    "skills.catalogLink": "Open the detailed guide to all 17 skills",
    ...
    "skills.pluginLabel": "Install as a Claude Code plugin",
    "skills.pluginDescription": "Add the same package from inside Claude Code, with no shell.",
