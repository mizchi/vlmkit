...
- **A1** — Build component from PNG screenshot
  - code: `src/component-from-image.ts`
...
- **J1** — Cross-page component drift
  - code: `src/multi-page-consistency.ts`
