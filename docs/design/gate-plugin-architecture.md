...
## The 27 gates (153 tunable rules)
...
| `check copy` | 6 | markup |
| `check interactions` | 30 | markup |<!-- 15 of its own + the 15 shared HANDLER_SURFACE_RULES it emits under --handlers -->
