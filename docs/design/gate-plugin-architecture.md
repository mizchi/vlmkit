...
Status: **landed**. All 30 gates are registry-driven; the MCP tools,
...
**All 30 gates render their settings themselves** — the last 16 landed together.
...
## The 30 gates (191 tunable rules)
...
| `check composition` | 6 | markup |
| `check color` | 6 | markup |
