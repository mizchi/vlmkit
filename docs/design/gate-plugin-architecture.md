...
Status: **landed**. All 31 gates are registry-driven; the MCP tools,
...
**All 31 gates render their settings themselves** — the last 16 landed together.
...
## The 31 gates (192 tunable rules)
