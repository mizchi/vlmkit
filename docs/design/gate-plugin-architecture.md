...
Status: **landed**. All 29 gates are registry-driven; the MCP tools,
...
**All 29 gates render their settings themselves** — the last 16 landed together.
...
## The 29 gates (185 tunable rules)
