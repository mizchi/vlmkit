...
## The 27 gates (149 tunable rules)
...
| `check copy` | 6 | markup |
| `check interactions` | 28 | markup |<!-- 15 of its own + the 13 shared HANDLER_SURFACE_RULES it emits under --handlers -->
