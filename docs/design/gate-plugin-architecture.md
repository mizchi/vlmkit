...
## The 27 gates (155 tunable rules)
...
| `check copy` | 6 | markup |
| `check interactions` | 31 | markup |<!-- 15 of its own + the 16 shared HANDLER_SURFACE_RULES it emits under --handlers -->
