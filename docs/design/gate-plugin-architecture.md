...
## The 27 gates (141 tunable rules)
...
| `check copy` | 6 | markup |
| `check interactions` | 24 | markup |<!-- 15 of its own + the 7 shared HANDLER_SURFACE_RULES it emits under --handlers -->
