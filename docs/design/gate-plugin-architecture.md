...
## The 27 gates (137 tunable rules)
...
| `check copy` | 6 | markup |
| `check interactions` | 22 | markup |<!-- 15 of its own + the 7 shared HANDLER_SURFACE_RULES it emits under --handlers -->
