...
```bash
pnpm add @mizchi/vlmkit-capture
```

## Usage

```ts
import { discoverViewports, resolveCaptureRoutes } from "@mizchi/vlmkit-capture";
...
```ts
import { capturePage } from "@mizchi/vlmkit-capture/capturer.ts";
```
