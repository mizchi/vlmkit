...
${ALLOW_HELP}`,
  ...
  inputs: [
    ...
    { name: "viewports", kind: "number-list", description: "Sweep widths", defaultDescription: "1280,768,375" },
    { name: "max-findings", kind: "number", description: "Per-class report cap", defaultDescription: "12" },
    { name: "timeout", kind: "number", description: "Page navigation timeout (ms)", defaultDescription: "30000" },
    {
      name: "wait-until",
      kind: "string",
    ...
    { name: "har", kind: "path", description: "Replay network responses from a Playwright HAR" },
    {
      name: "storage-state",
      kind: "path",
