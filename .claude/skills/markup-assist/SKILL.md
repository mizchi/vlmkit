...
| Question | Gate |
|---|---|
| Is anything broken? (JS errors, empty render, failed resources, text collision/clipping/protrusion, collapsed containers, overflow, invisible text, misalignment, unstyled page — 3 viewports) | `vlmkit check integrity page.html` |
