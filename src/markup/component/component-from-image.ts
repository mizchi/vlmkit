...
import { extractTextRowsFromFile, matchTextRows, computeRowGapDeltas, compareRowTypography, type MatchedTextRow, type RowGapDelta, type TypographyMismatch } from "../../util/text-rows.ts";
...
import { DIM, RESET, GREEN, RED, YELLOW, BOLD, CYAN } from "../../util/terminal-colors.ts";
