...
const GROUPS: Record<string, Record<string, { spec?: Spec; run?: (args: string[]) => Promise<void>; desc: string }>> = {
  ...
  check: {
    ...
    integrity: { spec: SPECS.integrityCheck, desc: "Reference-free defect gate: JS errors, empty render, broken resources, text collision/clipping, collapsed containers, overflow, unstyled page (multi-viewport)" },
